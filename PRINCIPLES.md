...
Target: x86_64 PC, RTX Pro 6000 (96 GB GDDR7, Blackwell `sm_120`), AMD 9950X3D, 64 GB RAM. Current runtime is bare-metal Ubuntu 24.04; WSL2 is historical setup context. Same binary across Linux environments is preferred, but OK to diverge if it solves a problem better. Single user, Tailscale-only.
...
- **Patch ledger stays current.** Keep [docs/fork-maintenance-policy.md](docs/fork-maintenance-policy.md) updated with what is adopted, candidate, historical, or dropped.
